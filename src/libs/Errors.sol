...
library Error {
    ...
    string public constant DIAMOND_INVALID_FUNCTION_SIGNATURE =
        "krDiamond: function does not exist";
    string public constant DIAMOND_INVALID_PENDING_OWNER =
        "krDiamond: Must be pending contract owner";
    string public constant DIAMOND_INVALID_OWNER =
        "krDiamond: Must be diamond owner";
