...
library MinterEvent {
     ...
     */
    event LiquidationIncentiveMultiplierUpdated(
        uint256 indexed liquidationIncentiveMultiplier
    );
     ...
     */
    event MinimumCollateralizationRatioUpdated(
        uint256 indexed minimumCollateralizationRatio
    );
...
library StakingEvent {
    event LiquidityAndStakeAdded(
        address indexed to,
        uint256 indexed amount,
        uint256 indexed pid
    );
    event LiquidityAndStakeRemoved(
        address indexed to,
        uint256 indexed amount,
        uint256 indexed pid
    );
...
library InterestRateEvent {
     ...
     * @dev Emitted when @param account repaid their @param asset interest @param value
     */
    event StabilityRateInterestRepaid(
        address indexed account,
        address indexed asset,
        uint256 value
    );
     ...
     */
    event StabilityRateInterestBatchRepaid(
        address indexed account,
        uint256 value
    );
