...
library LibDecimals {
    ...
    function divByPrice(
        uint256 _value,
        uint256 _priceWithOracleDecimals
    ) internal pure returns (uint256 wadValue) {
     ...
     */
    function fromWadPriceToUint(
        uint256 _wadPrice
    ) internal pure returns (uint256 priceWithOracleDecimals) {
        uint8 oracleDecimals = 8;
     ...
     */
    function oraclePriceToWad(
        int256 _priceWithOracleDecimals
    ) internal pure returns (uint256) {
        uint8 oracleDecimals = 8;
