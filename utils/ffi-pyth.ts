...
if (process.argv.length < 3) {
  error(
    'Invalid arguments. Example: `bun run lib/kresko-lib/utils/ffi-pyth.ts ETH,BTC` or `bun run lib/kresko-lib/utils/ffi-pyth.ts 0xff61491a931112ddf1bd8147cd1b641375f79f5825126d665480874634fd0ace,0xe62df6c8b4a85fe1a67db44dc12de5db330f7ac66b72dc658afedf0f4a415b43`',
  )
}
